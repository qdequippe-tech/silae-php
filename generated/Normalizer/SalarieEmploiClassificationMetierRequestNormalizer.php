...
class SalarieEmploiClassificationMetierRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return SalarieEmploiClassificationMetierRequest::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && SalarieEmploiClassificationMetierRequest::class === $data::class;
    }
    ...
    {
        return [SalarieEmploiClassificationMetierRequest::class => false];
    }
}
