...
class SalarieEmploiClassificationMetierRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\SalarieEmploiClassificationMetierRequest' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\SalarieEmploiClassificationMetierRequest' === $data::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new SalarieEmploiClassificationMetierRequest();
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\SalarieEmploiClassificationMetierRequest' => false];
    }
}
