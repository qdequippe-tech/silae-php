...
class ExtraSalarieAjouterVacationsRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \is_object($data) && ExtraSalarieAjouterVacationsRequest::class === $data::class;
    }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('extraSalarieVacations') && null !== $data->getExtraSalarieVacations()) {
            $dataArray['extraSalarieVacations'] = $this->normalizer->normalize($data->getExtraSalarieVacations(), 'json', $context);
        }
