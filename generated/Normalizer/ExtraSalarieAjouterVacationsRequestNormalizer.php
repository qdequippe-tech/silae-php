...
class ExtraSalarieAjouterVacationsRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\ExtraSalarieAjouterVacationsRequest' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\ExtraSalarieAjouterVacationsRequest' === $data::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('extraSalarieVacations', $data) && null !== $data['extraSalarieVacations']) {
            $object->setExtraSalarieVacations($this->denormalizer->denormalize($data['extraSalarieVacations'], 'QdequippeTech\\Silae\\Api\\Model\\ExtraSalarieVacations', 'json', $context));
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\ExtraSalarieAjouterVacationsRequest' => false];
    }
}
