...
class SalarieSalaireDeBaseRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return SalarieSalaireDeBaseRequest::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && SalarieSalaireDeBaseRequest::class === $data::class;
    }
    ...
    {
        return [SalarieSalaireDeBaseRequest::class => false];
    }
}
