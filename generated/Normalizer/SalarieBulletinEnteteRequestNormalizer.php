...
class SalarieBulletinEnteteRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\SalarieBulletinEnteteRequest' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\SalarieBulletinEnteteRequest' === $data::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('requeteSalarieBulletinEntete', $data) && null !== $data['requeteSalarieBulletinEntete']) {
            $object->setRequeteSalarieBulletinEntete($this->denormalizer->denormalize($data['requeteSalarieBulletinEntete'], 'QdequippeTech\\Silae\\Api\\Model\\RequeteSalarieBulletinEntete', 'json', $context));
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\SalarieBulletinEnteteRequest' => false];
    }
}
