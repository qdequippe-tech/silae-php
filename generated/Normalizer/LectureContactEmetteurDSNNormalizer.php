...
class LectureContactEmetteurDSNNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\LectureContactEmetteurDSN' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\LectureContactEmetteurDSN' === $data::class;
    }
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\LectureContactEmetteurDSN' => false];
    }
}
