...
class ListeSalarieEmploisRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \is_object($data) && ListeSalarieEmploisRequest::class === $data::class;
    }
    ...
    {
        $dataArray = [];
        if ($data->isInitialized('typeEmplois') && null !== $data->getTypeEmplois()) {
            $dataArray['typeEmplois'] = $data->getTypeEmplois();
        }
