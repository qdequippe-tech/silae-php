...
class StatutAnalyseProductionPaieDocumentsSignesAsynchroneResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return StatutAnalyseProductionPaieDocumentsSignesAsynchroneResponse::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && StatutAnalyseProductionPaieDocumentsSignesAsynchroneResponse::class === $data::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new StatutAnalyseProductionPaieDocumentsSignesAsynchroneResponse();
        ...
        if (\array_key_exists('statistiques', $data) && null !== $data['statistiques']) {
            ...
            foreach ($data['statistiques'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, StatistiquesDocumentsSignes::class, 'json', $context);
            }
    ...
    {
        return [StatutAnalyseProductionPaieDocumentsSignesAsynchroneResponse::class => false];
    }
}
