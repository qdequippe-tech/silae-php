...
class MatriculeSalarieRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \is_object($data) && MatriculeSalarieRequest::class === $data::class;
    }
    ...
    {
        $dataArray = [];
        if ($data->isInitialized('matriculeInterneSalarie') && null !== $data->getMatriculeInterneSalarie()) {
            $dataArray['matriculeInterneSalarie'] = $data->getMatriculeInterneSalarie();
        }
