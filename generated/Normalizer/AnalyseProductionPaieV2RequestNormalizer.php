...
class AnalyseProductionPaieV2RequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return AnalyseProductionPaieV2Request::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && AnalyseProductionPaieV2Request::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new AnalyseProductionPaieV2Request();
    ...
    {
        return [AnalyseProductionPaieV2Request::class => false];
    }
}
