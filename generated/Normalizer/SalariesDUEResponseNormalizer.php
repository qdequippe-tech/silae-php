...
class SalariesDUEResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\SalariesDUEResponse' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\SalariesDUEResponse' === $data::class;
    }
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\SalariesDUEResponse' => false];
    }
}
