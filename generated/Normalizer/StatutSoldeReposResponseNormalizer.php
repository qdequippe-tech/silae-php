...
class StatutSoldeReposResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\StatutSoldeReposResponse' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\StatutSoldeReposResponse' === $data::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \QdequippeTech\Silae\Api\Model\StatutSoldeReposResponse();
        ...
        if (\array_key_exists('soldeRepos', $data) && null !== $data['soldeRepos']) {
            $object->setSoldeRepos($this->denormalizer->denormalize($data['soldeRepos'], 'QdequippeTech\\Silae\\Api\\Model\\SoldeRepos', 'json', $context));
