...
class RequeteSalarieAbsencesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return RequeteSalarieAbsences::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && RequeteSalarieAbsences::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new RequeteSalarieAbsences();
        ...
        if (\array_key_exists('optionFiltrage', $data) && null !== $data['optionFiltrage']) {
            $object->setOptionFiltrage($data['optionFiltrage']);
        } elseif (\array_key_exists('optionFiltrage', $data) && null === $data['optionFiltrage']) {
            $object->setOptionFiltrage(null);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('optionFiltrage') && null !== $data->getOptionFiltrage()) {
            $dataArray['optionFiltrage'] = $data->getOptionFiltrage();
        }
    ...
    {
        return [RequeteSalarieAbsences::class => false];
    }
}
