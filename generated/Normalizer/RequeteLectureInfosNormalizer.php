...
class RequeteLectureInfosNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \is_object($data) && RequeteLectureInfos::class === $data::class;
    }
    ...
    {
        $dataArray = [];
        if ($data->isInitialized('tableInformations') && null !== $data->getTableInformations()) {
            $dataArray['tableInformations'] = $data->getTableInformations();
        }
        ...
        if ($data->isInitialized('champs') && null !== $data->getChamps()) {
            $values = [];
            foreach ($data->getChamps() as $value) {
                $values[] = $value;
            }

            $dataArray['champs'] = $values;
        }
