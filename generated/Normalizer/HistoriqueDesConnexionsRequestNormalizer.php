...
class HistoriqueDesConnexionsRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return HistoriqueDesConnexionsRequest::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && HistoriqueDesConnexionsRequest::class === $data::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new HistoriqueDesConnexionsRequest();
        ...
        if (\array_key_exists('filtre', $data) && null !== $data['filtre']) {
            $object->setFiltre($data['filtre']);
        } elseif (\array_key_exists('filtre', $data) && null === $data['filtre']) {
            $object->setFiltre(null);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('filtre') && null !== $data->getFiltre()) {
            $dataArray['filtre'] = $data->getFiltre();
        }
    ...
    {
        return [HistoriqueDesConnexionsRequest::class => false];
    }
}
