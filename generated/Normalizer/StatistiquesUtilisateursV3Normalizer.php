...
class StatistiquesUtilisateursV3Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return StatistiquesUtilisateursV3::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && StatistiquesUtilisateursV3::class === $data::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new StatistiquesUtilisateursV3();
        ...
        if (\array_key_exists('statistiquesProductionUtilisateurs', $data) && null !== $data['statistiquesProductionUtilisateurs']) {
            ...
            foreach ($data['statistiquesProductionUtilisateurs'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, StatistiquesProductionUtilisateurV3::class, 'json', $context);
            }
    ...
    {
        return [StatistiquesUtilisateursV3::class => false];
    }
}
