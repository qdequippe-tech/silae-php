...
class EcrituresComptables2RequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\EcrituresComptables2Request' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\EcrituresComptables2Request' === $data::class;
    }
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\EcrituresComptables2Request' => false];
    }
}
