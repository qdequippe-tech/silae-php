...
class StatutAnalyseProductionPaieRevenusAsynchroneResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return StatutAnalyseProductionPaieRevenusAsynchroneResponse::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && StatutAnalyseProductionPaieRevenusAsynchroneResponse::class === $data::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new StatutAnalyseProductionPaieRevenusAsynchroneResponse();
        ...
        if (\array_key_exists('statistiques', $data) && null !== $data['statistiques']) {
            ...
            foreach ($data['statistiques'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, StatistiquesRevenus::class, 'json', $context);
            }
    ...
    {
        return [StatutAnalyseProductionPaieRevenusAsynchroneResponse::class => false];
    }
}
