...
class RechercheCCNResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return RechercheCCNResponse::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && RechercheCCNResponse::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('ccn', $data) && null !== $data['ccn']) {
            ...
            foreach ($data['ccn'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, CCN::class, 'json', $context);
            }
    ...
    {
        $dataArray = [];
        if ($data->isInitialized('ccn') && null !== $data->getCcn()) {
            $values = [];
            foreach ($data->getCcn() as $value) {
                $values[] = $this->normalizer->normalize($value, 'json', $context);
            }

            $dataArray['ccn'] = $values;
        }
    ...
    {
        return [RechercheCCNResponse::class => false];
    }
}
