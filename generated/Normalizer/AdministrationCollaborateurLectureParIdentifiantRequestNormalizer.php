...
class AdministrationCollaborateurLectureParIdentifiantRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\AdministrationCollaborateurLectureParIdentifiantRequest' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\AdministrationCollaborateurLectureParIdentifiantRequest' === $data::class;
    }
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\AdministrationCollaborateurLectureParIdentifiantRequest' => false];
    }
}
