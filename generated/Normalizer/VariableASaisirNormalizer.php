...
class VariableASaisirNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return VariableASaisir::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && VariableASaisir::class === $data::class;
    }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('libelleLong') && null !== $data->getLibelleLong()) {
            $dataArray['libelle_Long'] = $data->getLibelleLong();
        }

        if ($data->isInitialized('libelleCourt') && null !== $data->getLibelleCourt()) {
            $dataArray['libelle_Court'] = $data->getLibelleCourt();
        }

        if ($data->isInitialized('typeVariable') && null !== $data->getTypeVariable()) {
            $dataArray['type_Variable'] = $data->getTypeVariable();
        }
        ...
        if ($data->isInitialized('indiceCouleur') && null !== $data->getIndiceCouleur()) {
            $dataArray['indiceCouleur'] = $data->getIndiceCouleur();
        }

        if ($data->isInitialized('masquee') && null !== $data->getMasquee()) {
            $dataArray['masquee'] = $data->getMasquee();
        }
    ...
    {
        return [VariableASaisir::class => false];
    }
}
