...
class StatutAnalyseProductionPaieEffectifsAsynchroneResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return StatutAnalyseProductionPaieEffectifsAsynchroneResponse::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && StatutAnalyseProductionPaieEffectifsAsynchroneResponse::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new StatutAnalyseProductionPaieEffectifsAsynchroneResponse();
        ...
        if (\array_key_exists('effectifs', $data) && null !== $data['effectifs']) {
            $values = [];
            foreach ($data['effectifs'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, AnalyseEffectifs::class, 'json', $context);
            }

            $object->setEffectifs($values);
        } elseif (\array_key_exists('effectifs', $data) && null === $data['effectifs']) {
            $object->setEffectifs(null);
        }
    ...
    {
        $dataArray = [];
        if ($data->isInitialized('effectifs') && null !== $data->getEffectifs()) {
            $values = [];
            foreach ($data->getEffectifs() as $value) {
                $values[] = $this->normalizer->normalize($value, 'json', $context);
            }

            $dataArray['effectifs'] = $values;
        }
    ...
    {
        return [StatutAnalyseProductionPaieEffectifsAsynchroneResponse::class => false];
    }
}
