...
class ListeComptesApiResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\ListeComptesApiResponse' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\ListeComptesApiResponse' === $data::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('comptes', $data) && null !== $data['comptes']) {
            ...
            foreach ($data['comptes'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'QdequippeTech\\Silae\\Api\\Model\\CompteApi', 'json', $context);
            }
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\ListeComptesApiResponse' => false];
    }
}
