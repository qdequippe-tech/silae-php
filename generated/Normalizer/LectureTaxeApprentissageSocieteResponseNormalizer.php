...
class LectureTaxeApprentissageSocieteResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\LectureTaxeApprentissageSocieteResponse' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\LectureTaxeApprentissageSocieteResponse' === $data::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new LectureTaxeApprentissageSocieteResponse();
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\LectureTaxeApprentissageSocieteResponse' => false];
    }
}
