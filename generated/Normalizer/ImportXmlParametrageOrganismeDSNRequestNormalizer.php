...
class ImportXmlParametrageOrganismeDSNRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\ImportXmlParametrageOrganismeDSNRequest' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\ImportXmlParametrageOrganismeDSNRequest' === $data::class;
    }
    ...
    {
        $data = [];
        if ($object->isInitialized('xmlEnByteArray') && null !== $object->getXmlEnByteArray()) {
            $data['xmlEnByteArray'] = $object->getXmlEnByteArray();
        }
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\ImportXmlParametrageOrganismeDSNRequest' => false];
    }
}
