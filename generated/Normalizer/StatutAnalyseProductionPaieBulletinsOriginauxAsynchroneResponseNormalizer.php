...
class StatutAnalyseProductionPaieBulletinsOriginauxAsynchroneResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return StatutAnalyseProductionPaieBulletinsOriginauxAsynchroneResponse::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && StatutAnalyseProductionPaieBulletinsOriginauxAsynchroneResponse::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new StatutAnalyseProductionPaieBulletinsOriginauxAsynchroneResponse();
    ...
    {
        return [StatutAnalyseProductionPaieBulletinsOriginauxAsynchroneResponse::class => false];
    }
}
