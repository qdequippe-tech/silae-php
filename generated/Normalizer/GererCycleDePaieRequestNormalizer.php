...
class GererCycleDePaieRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return GererCycleDePaieRequest::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && GererCycleDePaieRequest::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('dossierTache', $data) && null !== $data['dossierTache']) {
            $object->setDossierTache($this->denormalizer->denormalize($data['dossierTache'], DossierTache::class, 'json', $context));
    ...
    {
        $dataArray = [];
        if ($data->isInitialized('dossierTache') && null !== $data->getDossierTache()) {
            $dataArray['dossierTache'] = $this->normalizer->normalize($data->getDossierTache(), 'json', $context);
        }
    ...
    {
        return [GererCycleDePaieRequest::class => false];
    }
}
