...
class AnalyseProductionPaieEffectifsRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return AnalyseProductionPaieEffectifsRequest::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && AnalyseProductionPaieEffectifsRequest::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new AnalyseProductionPaieEffectifsRequest();
    ...
    {
        return [AnalyseProductionPaieEffectifsRequest::class => false];
    }
}
