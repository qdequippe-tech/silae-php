...
class SousCategoriesEnPCNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \is_object($data) && SousCategoriesEnPC::class === $data::class;
    }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('sousCategorie') && null !== $data->getSousCategorie()) {
            $dataArray['sousCategorie'] = $data->getSousCategorie();
        }

        if ($data->isInitialized('pc') && null !== $data->getPc()) {
            $dataArray['pc'] = $data->getPc();
        }
