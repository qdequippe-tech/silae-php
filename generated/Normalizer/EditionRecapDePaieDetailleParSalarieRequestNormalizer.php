...
class EditionRecapDePaieDetailleParSalarieRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return EditionRecapDePaieDetailleParSalarieRequest::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && EditionRecapDePaieDetailleParSalarieRequest::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new EditionRecapDePaieDetailleParSalarieRequest();
    ...
    {
        return [EditionRecapDePaieDetailleParSalarieRequest::class => false];
    }
}
