...
class ListeInformationsDossiersPaieResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return ListeInformationsDossiersPaieResponse::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && ListeInformationsDossiersPaieResponse::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('informationsDossiersDePaie', $data) && null !== $data['informationsDossiersDePaie']) {
            ...
            foreach ($data['informationsDossiersDePaie'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, InformationsDossier::class, 'json', $context);
            }
    ...
    {
        $dataArray = [];
        if ($data->isInitialized('informationsDossiersDePaie') && null !== $data->getInformationsDossiersDePaie()) {
            $values = [];
            foreach ($data->getInformationsDossiersDePaie() as $value) {
                $values[] = $this->normalizer->normalize($value, 'json', $context);
            }

            $dataArray['informationsDossiersDePaie'] = $values;
        }
    ...
    {
        return [ListeInformationsDossiersPaieResponse::class => false];
    }
}
