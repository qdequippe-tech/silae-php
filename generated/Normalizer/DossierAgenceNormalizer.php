...
class DossierAgenceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\DossierAgence' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\DossierAgence' === $data::class;
    }
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\DossierAgence' => false];
    }
}
