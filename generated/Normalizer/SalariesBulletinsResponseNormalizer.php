...
class SalariesBulletinsResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\SalariesBulletinsResponse' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\SalariesBulletinsResponse' === $data::class;
    }
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\SalariesBulletinsResponse' => false];
    }
}
