...
class SiteGenereMotDePasseAlternatifRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \is_object($data) && SiteGenereMotDePasseAlternatifRequest::class === $data::class;
    }
    ...
    {
        $dataArray = [];
        if ($data->isInitialized('codeUtilisateur') && null !== $data->getCodeUtilisateur()) {
            $dataArray['codeUtilisateur'] = $data->getCodeUtilisateur();
        }
