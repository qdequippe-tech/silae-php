...
class CreationDossierPaieRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\CreationDossierPaieRequest' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\CreationDossierPaieRequest' === $data::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('dossier', $data) && null !== $data['dossier']) {
            $object->setDossier($this->denormalizer->denormalize($data['dossier'], 'QdequippeTech\\Silae\\Api\\Model\\Dossier', 'json', $context));
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\CreationDossierPaieRequest' => false];
    }
}
