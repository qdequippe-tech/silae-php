...
class LectureAxesAnalytiquesResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\LectureAxesAnalytiquesResponse' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\LectureAxesAnalytiquesResponse' === $data::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('axesAnalytiques', $data) && null !== $data['axesAnalytiques']) {
            ...
            foreach ($data['axesAnalytiques'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'QdequippeTech\\Silae\\Api\\Model\\AxeAnalytique', 'json', $context);
            }
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\LectureAxesAnalytiquesResponse' => false];
    }
}
