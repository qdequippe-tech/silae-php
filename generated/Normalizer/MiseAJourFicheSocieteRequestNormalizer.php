...
class MiseAJourFicheSocieteRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return MiseAJourFicheSocieteRequest::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && MiseAJourFicheSocieteRequest::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('societeInfoSup', $data) && null !== $data['societeInfoSup']) {
            $object->setSocieteInfoSup($this->denormalizer->denormalize($data['societeInfoSup'], SocieteInfoSup::class, 'json', $context));
    ...
    {
        $dataArray = [];
        if ($data->isInitialized('societeInfoSup') && null !== $data->getSocieteInfoSup()) {
            $dataArray['societeInfoSup'] = $this->normalizer->normalize($data->getSocieteInfoSup(), 'json', $context);
        }
    ...
    {
        return [MiseAJourFicheSocieteRequest::class => false];
    }
}
