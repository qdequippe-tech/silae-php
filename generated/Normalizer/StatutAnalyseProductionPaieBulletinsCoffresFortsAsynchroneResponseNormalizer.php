...
class StatutAnalyseProductionPaieBulletinsCoffresFortsAsynchroneResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return StatutAnalyseProductionPaieBulletinsCoffresFortsAsynchroneResponse::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && StatutAnalyseProductionPaieBulletinsCoffresFortsAsynchroneResponse::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new StatutAnalyseProductionPaieBulletinsCoffresFortsAsynchroneResponse();
    ...
    {
        return [StatutAnalyseProductionPaieBulletinsCoffresFortsAsynchroneResponse::class => false];
    }
}
