...
class LectureInformationsSalarieEmploiNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return LectureInformationsSalarieEmploi::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && LectureInformationsSalarieEmploi::class === $data::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new LectureInformationsSalarieEmploi();
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('dateDebutContrat') && null !== $data->getDateDebutContrat()) {
            $dataArray['dateDebutContrat'] = $data->getDateDebutContrat()->format('Y-m-d\TH:i:s');
        }
    ...
    {
        return [LectureInformationsSalarieEmploi::class => false];
    }
}
