...
class CreationSalarieEmploisRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\CreationSalarieEmploisRequest' === $type;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('salarieEmplois', $data) && null !== $data['salarieEmplois']) {
            $object->setSalarieEmplois($this->denormalizer->denormalize($data['salarieEmplois'], 'QdequippeTech\\Silae\\Api\\Model\\SalarieEmplois', 'json', $context));
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\CreationSalarieEmploisRequest' => false];
    }
}
