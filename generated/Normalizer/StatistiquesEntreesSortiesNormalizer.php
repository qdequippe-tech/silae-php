...
class StatistiquesEntreesSortiesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\StatistiquesEntreesSorties' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\StatistiquesEntreesSorties' === $data::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('statistiquesEntreesSortiesDetails', $data) && null !== $data['statistiquesEntreesSortiesDetails']) {
            ...
            foreach ($data['statistiquesEntreesSortiesDetails'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'QdequippeTech\\Silae\\Api\\Model\\StatistiquesEntreesSortiesDetails', 'json', $context);
            }
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\StatistiquesEntreesSorties' => false];
    }
}
