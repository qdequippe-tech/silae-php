...
class SousCategorieNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\SousCategorie' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\SousCategorie' === $data::class;
    }
    ...
    public function normalize($object, $format = null, array $context = [])
    {
        ...
        if ($object->isInitialized('nouveauNomSousCategorie') && null !== $object->getNouveauNomSousCategorie()) {
            $data['nouveauNomSousCategorie'] = $object->getNouveauNomSousCategorie();
        }
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\SousCategorie' => false];
    }
}
