...
class ProprietesChiffrementNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\ProprietesChiffrement' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\ProprietesChiffrement' === $data::class;
    }
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\ProprietesChiffrement' => false];
    }
}
