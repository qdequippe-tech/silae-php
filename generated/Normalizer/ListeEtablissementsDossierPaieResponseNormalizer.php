...
class ListeEtablissementsDossierPaieResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return ListeEtablissementsDossierPaieResponse::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && ListeEtablissementsDossierPaieResponse::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('informationsEtablissements', $data) && null !== $data['informationsEtablissements']) {
            ...
            foreach ($data['informationsEtablissements'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, InformationsEtablissement::class, 'json', $context);
            }
    ...
    {
        $dataArray = [];
        if ($data->isInitialized('informationsEtablissements') && null !== $data->getInformationsEtablissements()) {
            $values = [];
            foreach ($data->getInformationsEtablissements() as $value) {
                $values[] = $this->normalizer->normalize($value, 'json', $context);
            }

            $dataArray['informationsEtablissements'] = $values;
        }
    ...
    {
        return [ListeEtablissementsDossierPaieResponse::class => false];
    }
}
