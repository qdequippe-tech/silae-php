...
class SalarieRecupererPeriodeDernierBulletinCalculeResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\SalarieRecupererPeriodeDernierBulletinCalculeResponse' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\SalarieRecupererPeriodeDernierBulletinCalculeResponse' === $data::class;
    }
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\SalarieRecupererPeriodeDernierBulletinCalculeResponse' => false];
    }
}
