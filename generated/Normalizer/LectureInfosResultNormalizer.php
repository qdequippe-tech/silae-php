...
class LectureInfosResultNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\LectureInfosResult' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\LectureInfosResult' === $data::class;
    }
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\LectureInfosResult' => false];
    }
}
