...
class SiteGenereMotDePasseAlternatifResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\SiteGenereMotDePasseAlternatifResponse' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\SiteGenereMotDePasseAlternatifResponse' === $data::class;
    }
    ...
    {
        $data = [];
        if ($object->isInitialized('motDePasseAlternatif') && null !== $object->getMotDePasseAlternatif()) {
            $data['motDePasseAlternatif'] = $object->getMotDePasseAlternatif();
        }
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\SiteGenereMotDePasseAlternatifResponse' => false];
    }
}
