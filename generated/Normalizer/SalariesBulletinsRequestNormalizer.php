...
class SalariesBulletinsRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\SalariesBulletinsRequest' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\SalariesBulletinsRequest' === $data::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('requeteSalariesBulletins', $data) && null !== $data['requeteSalariesBulletins']) {
            $object->setRequeteSalariesBulletins($this->denormalizer->denormalize($data['requeteSalariesBulletins'], 'QdequippeTech\\Silae\\Api\\Model\\RequeteSalariesBulletins', 'json', $context));
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\SalariesBulletinsRequest' => false];
    }
}
