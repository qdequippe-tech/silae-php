...
class CreationCompteCollaborateurRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\CreationCompteCollaborateurRequest' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\CreationCompteCollaborateurRequest' === $data::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('utilisateurCollaborateur', $data) && null !== $data['utilisateurCollaborateur']) {
            $object->setUtilisateurCollaborateur($this->denormalizer->denormalize($data['utilisateurCollaborateur'], 'QdequippeTech\\Silae\\Api\\Model\\CompteCollaborateur', 'json', $context));
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\CreationCompteCollaborateurRequest' => false];
    }
}
