...
class CreationConfigurationAccesApiRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\CreationConfigurationAccesApiRequest' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\CreationConfigurationAccesApiRequest' === $data::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('configuration', $data) && null !== $data['configuration']) {
            $object->setConfiguration($this->denormalizer->denormalize($data['configuration'], 'QdequippeTech\\Silae\\Api\\Model\\CreationConfigurationAccesApi', 'json', $context));
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\CreationConfigurationAccesApiRequest' => false];
    }
}
