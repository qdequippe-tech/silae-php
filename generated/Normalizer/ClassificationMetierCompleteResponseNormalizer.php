...
class ClassificationMetierCompleteResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\ClassificationMetierCompleteResponse' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\ClassificationMetierCompleteResponse' === $data::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('emploisClassificationsMetiers', $data) && null !== $data['emploisClassificationsMetiers']) {
            ...
            foreach ($data['emploisClassificationsMetiers'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'QdequippeTech\\Silae\\Api\\Model\\EmploiClassificationMetier', 'json', $context);
            }
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\ClassificationMetierCompleteResponse' => false];
    }
}
