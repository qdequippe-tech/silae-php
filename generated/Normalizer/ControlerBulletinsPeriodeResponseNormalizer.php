...
class ControlerBulletinsPeriodeResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \is_object($data) && ControlerBulletinsPeriodeResponse::class === $data::class;
    }
    ...
    {
        $dataArray = [];
        if ($data->isInitialized('nbBulletinsControles') && null !== $data->getNbBulletinsControles()) {
            $dataArray['nbBulletinsControles'] = $data->getNbBulletinsControles();
        }
