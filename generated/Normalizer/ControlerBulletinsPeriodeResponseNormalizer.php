...
class ControlerBulletinsPeriodeResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\ControlerBulletinsPeriodeResponse' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\ControlerBulletinsPeriodeResponse' === $data::class;
    }
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\ControlerBulletinsPeriodeResponse' => false];
    }
}
