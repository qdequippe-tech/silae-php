...
class EditionEtatDesPaiementsRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return EditionEtatDesPaiementsRequest::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && EditionEtatDesPaiementsRequest::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new EditionEtatDesPaiementsRequest();
    ...
    {
        return [EditionEtatDesPaiementsRequest::class => false];
    }
}
