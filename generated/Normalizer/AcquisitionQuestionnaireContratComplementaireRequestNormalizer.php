...
class AcquisitionQuestionnaireContratComplementaireRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return AcquisitionQuestionnaireContratComplementaireRequest::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && AcquisitionQuestionnaireContratComplementaireRequest::class === $data::class;
    }
    ...
    {
        return [AcquisitionQuestionnaireContratComplementaireRequest::class => false];
    }
}
