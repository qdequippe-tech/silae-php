...
class SalarieBulletinStatutEtatAvancementRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return SalarieBulletinStatutEtatAvancementRequest::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && SalarieBulletinStatutEtatAvancementRequest::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new SalarieBulletinStatutEtatAvancementRequest();
    ...
    {
        return [SalarieBulletinStatutEtatAvancementRequest::class => false];
    }
}
