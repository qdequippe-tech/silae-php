...
class PersonneLieeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\PersonneLiee' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\PersonneLiee' === $data::class;
    }
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\PersonneLiee' => false];
    }
}
