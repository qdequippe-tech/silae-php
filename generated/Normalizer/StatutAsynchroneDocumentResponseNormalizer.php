...
class StatutAsynchroneDocumentResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return StatutAsynchroneDocumentResponse::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && StatutAsynchroneDocumentResponse::class === $data::class;
    }
    ...
    {
        return [StatutAsynchroneDocumentResponse::class => false];
    }
}
