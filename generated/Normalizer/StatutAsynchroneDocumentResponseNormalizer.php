...
class StatutAsynchroneDocumentResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\StatutAsynchroneDocumentResponse' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\StatutAsynchroneDocumentResponse' === $data::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new StatutAsynchroneDocumentResponse();
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\StatutAsynchroneDocumentResponse' => false];
    }
}
