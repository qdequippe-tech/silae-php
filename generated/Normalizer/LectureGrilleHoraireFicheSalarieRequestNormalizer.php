...
class LectureGrilleHoraireFicheSalarieRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return LectureGrilleHoraireFicheSalarieRequest::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && LectureGrilleHoraireFicheSalarieRequest::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new LectureGrilleHoraireFicheSalarieRequest();
    ...
    {
        return [LectureGrilleHoraireFicheSalarieRequest::class => false];
    }
}
