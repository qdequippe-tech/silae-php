...
class RequeteSpectacleSalarieAffectationsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\RequeteSpectacleSalarieAffectations' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\RequeteSpectacleSalarieAffectations' === $data::class;
    }
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\RequeteSpectacleSalarieAffectations' => false];
    }
}
