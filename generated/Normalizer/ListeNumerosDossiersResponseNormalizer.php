...
class ListeNumerosDossiersResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \is_object($data) && ListeNumerosDossiersResponse::class === $data::class;
    }
    ...
    {
        $dataArray = [];
        if ($data->isInitialized('listeNumerosDossiers') && null !== $data->getListeNumerosDossiers()) {
            $values = [];
            foreach ($data->getListeNumerosDossiers() as $value) {
                $values[] = $value;
            }

            $dataArray['listeNumerosDossiers'] = $values;
        }
