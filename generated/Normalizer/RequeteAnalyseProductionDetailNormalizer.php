...
class RequeteAnalyseProductionDetailNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\RequeteAnalyseProductionDetail' === $data::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \QdequippeTech\Silae\Api\Model\RequeteAnalyseProductionDetail();
