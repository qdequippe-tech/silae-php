...
class SalarieActiviteJournaliereSaisieNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return SalarieActiviteJournaliereSaisie::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && SalarieActiviteJournaliereSaisie::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new SalarieActiviteJournaliereSaisie();
    ...
    {
        return [SalarieActiviteJournaliereSaisie::class => false];
    }
}
