...
class SalarieInitialiserCumulsRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\SalarieInitialiserCumulsRequest' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\SalarieInitialiserCumulsRequest' === $data::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('salarieCumuls', $data) && null !== $data['salarieCumuls']) {
            $object->setSalarieCumuls($this->denormalizer->denormalize($data['salarieCumuls'], 'QdequippeTech\\Silae\\Api\\Model\\SalarieCumuls', 'json', $context));
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\SalarieInitialiserCumulsRequest' => false];
    }
}
