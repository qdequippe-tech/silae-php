...
class SalarieInitialiserCumulsRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \is_object($data) && SalarieInitialiserCumulsRequest::class === $data::class;
    }
    ...
    {
        $dataArray = [];
        if ($data->isInitialized('salarieCumuls') && null !== $data->getSalarieCumuls()) {
            $dataArray['salarieCumuls'] = $this->normalizer->normalize($data->getSalarieCumuls(), 'json', $context);
        }
