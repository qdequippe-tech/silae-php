...
class StatistiquesDocumentsSignesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return StatistiquesDocumentsSignes::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && StatistiquesDocumentsSignes::class === $data::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new StatistiquesDocumentsSignes();
        ...
        if (\array_key_exists('statistiquesProduction', $data) && null !== $data['statistiquesProduction']) {
            ...
            foreach ($data['statistiquesProduction'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, StatistiquesProductionDocumentsSignes::class, 'json', $context);
            }
    ...
    {
        return [StatistiquesDocumentsSignes::class => false];
    }
}
