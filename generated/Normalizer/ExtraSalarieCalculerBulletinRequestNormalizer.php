...
class ExtraSalarieCalculerBulletinRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\ExtraSalarieCalculerBulletinRequest' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\ExtraSalarieCalculerBulletinRequest' === $data::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new ExtraSalarieCalculerBulletinRequest();
        ...
        if (\array_key_exists('requeteExtraSalarieVacations', $data) && null !== $data['requeteExtraSalarieVacations']) {
            $object->setRequeteExtraSalarieVacations($this->denormalizer->denormalize($data['requeteExtraSalarieVacations'], 'QdequippeTech\\Silae\\Api\\Model\\RequeteExtraSalarieVacations', 'json', $context));
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\ExtraSalarieCalculerBulletinRequest' => false];
    }
}
