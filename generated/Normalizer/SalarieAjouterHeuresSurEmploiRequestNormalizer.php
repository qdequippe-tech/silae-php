...
class SalarieAjouterHeuresSurEmploiRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return SalarieAjouterHeuresSurEmploiRequest::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && SalarieAjouterHeuresSurEmploiRequest::class === $data::class;
    }
    ...
    {
        return [SalarieAjouterHeuresSurEmploiRequest::class => false];
    }
}
