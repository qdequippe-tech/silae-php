...
class DossierDemoSilaeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \is_object($data) && DossierDemoSilae::class === $data::class;
    }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('nomDossier') && null !== $data->getNomDossier()) {
            $dataArray['nomDossier'] = $data->getNomDossier();
        }
