...
class RequeteSalarieBulletinIndicesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return RequeteSalarieBulletinIndices::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && RequeteSalarieBulletinIndices::class === $data::class;
    }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('bulletinsOriginauxSeulement') && null !== $data->getBulletinsOriginauxSeulement()) {
            $dataArray['bulletinsOriginauxSeulement'] = $data->getBulletinsOriginauxSeulement();
        }
    ...
    {
        return [RequeteSalarieBulletinIndices::class => false];
    }
}
