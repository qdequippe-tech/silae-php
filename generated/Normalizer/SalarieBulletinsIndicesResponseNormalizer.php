...
class SalarieBulletinsIndicesResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return SalarieBulletinsIndicesResponse::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && SalarieBulletinsIndicesResponse::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new SalarieBulletinsIndicesResponse();
        ...
        if (\array_key_exists('salariesBulletins', $data) && null !== $data['salariesBulletins']) {
            ...
            foreach ($data['salariesBulletins'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, SalarieBulletinsIndicesResult::class, 'json', $context);
            }
    ...
    {
        return [SalarieBulletinsIndicesResponse::class => false];
    }
}
