...
class SalarieAjouterHeuresNativesSurEmploiRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return SalarieAjouterHeuresNativesSurEmploiRequest::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && SalarieAjouterHeuresNativesSurEmploiRequest::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new SalarieAjouterHeuresNativesSurEmploiRequest();
        ...
        if (\array_key_exists('heures', $data) && null !== $data['heures']) {
            $object->setHeures($this->denormalizer->denormalize($data['heures'], SalarieHeures::class, 'json', $context));
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('heures') && null !== $data->getHeures()) {
            $dataArray['heures'] = $this->normalizer->normalize($data->getHeures(), 'json', $context);
        }
    ...
    {
        return [SalarieAjouterHeuresNativesSurEmploiRequest::class => false];
    }
}
