...
class LectureQuestionnaireContratComplementaireRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return LectureQuestionnaireContratComplementaireRequest::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && LectureQuestionnaireContratComplementaireRequest::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new LectureQuestionnaireContratComplementaireRequest();
    ...
    {
        return [LectureQuestionnaireContratComplementaireRequest::class => false];
    }
}
