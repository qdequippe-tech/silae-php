...
class ListeMatriculesDupliquesRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\ListeMatriculesDupliquesRequest' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\ListeMatriculesDupliquesRequest' === $data::class;
    }
    ...
    {
        $data = [];
        if ($object->isInitialized('filtreMatricule') && null !== $object->getFiltreMatricule()) {
            $data['filtreMatricule'] = $object->getFiltreMatricule();
        }
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\ListeMatriculesDupliquesRequest' => false];
    }
}
