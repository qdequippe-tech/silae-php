...
class PersonneLieeV2Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return PersonneLieeV2::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && PersonneLieeV2::class === $data::class;
    }
    ...
    {
        return [PersonneLieeV2::class => false];
    }
}
