...
class StatistiquesBulletinCoffreFortNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return StatistiquesBulletinCoffreFort::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && StatistiquesBulletinCoffreFort::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new StatistiquesBulletinCoffreFort();
        ...
        if (\array_key_exists('statistiquesProduction', $data) && null !== $data['statistiquesProduction']) {
            ...
            foreach ($data['statistiquesProduction'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, StatistiquesProductionBulletinCoffreFort::class, 'json', $context);
            }
    ...
    {
        return [StatistiquesBulletinCoffreFort::class => false];
    }
}
