...
class ModificationQuestionnaireContratComplementaireRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return ModificationQuestionnaireContratComplementaireRequest::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && ModificationQuestionnaireContratComplementaireRequest::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new ModificationQuestionnaireContratComplementaireRequest();
        ...
        if (\array_key_exists('reponseQCComp', $data) && null !== $data['reponseQCComp']) {
            ...
            foreach ($data['reponseQCComp'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, ModificationChampByte::class, 'json', $context);
            }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('reponseQCComp') && null !== $data->getReponseQCComp()) {
            $values = [];
            foreach ($data->getReponseQCComp() as $value) {
                $values[] = $this->normalizer->normalize($value, 'json', $context);
            }

            $dataArray['reponseQCComp'] = $values;
        }
    ...
    {
        return [ModificationQuestionnaireContratComplementaireRequest::class => false];
    }
}
