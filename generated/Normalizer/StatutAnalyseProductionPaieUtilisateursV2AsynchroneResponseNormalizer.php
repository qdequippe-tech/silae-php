...
class StatutAnalyseProductionPaieUtilisateursV2AsynchroneResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return StatutAnalyseProductionPaieUtilisateursV2AsynchroneResponse::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && StatutAnalyseProductionPaieUtilisateursV2AsynchroneResponse::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new StatutAnalyseProductionPaieUtilisateursV2AsynchroneResponse();
    ...
    {
        return [StatutAnalyseProductionPaieUtilisateursV2AsynchroneResponse::class => false];
    }
}
