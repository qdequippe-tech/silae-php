...
class SoldeReposNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\SoldeRepos' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\SoldeRepos' === $data::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('soldeReposSalaries', $data) && null !== $data['soldeReposSalaries']) {
            ...
            foreach ($data['soldeReposSalaries'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'QdequippeTech\\Silae\\Api\\Model\\SoldeReposSalarie', 'json', $context);
            }
    ...
    public function normalize($object, $format = null, array $context = [])
    {
        ...
        if ($object->isInitialized('soldeReposSalaries') && null !== $object->getSoldeReposSalaries()) {
            $values = [];
            foreach ($object->getSoldeReposSalaries() as $value) {
                $values[] = $this->normalizer->normalize($value, 'json', $context);
            }
            $data['soldeReposSalaries'] = $values;
        }
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\SoldeRepos' => false];
    }
}
