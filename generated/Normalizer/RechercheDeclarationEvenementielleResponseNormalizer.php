...
class RechercheDeclarationEvenementielleResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \is_object($data) && RechercheDeclarationEvenementielleResponse::class === $data::class;
    }
    ...
    {
        $dataArray = [];
        if ($data->isInitialized('listeDeclarationEvenementielle') && null !== $data->getListeDeclarationEvenementielle()) {
            $values = [];
            foreach ($data->getListeDeclarationEvenementielle() as $value) {
                $values[] = $this->normalizer->normalize($value, 'json', $context);
            }

            $dataArray['listeDeclarationEvenementielle'] = $values;
        }
