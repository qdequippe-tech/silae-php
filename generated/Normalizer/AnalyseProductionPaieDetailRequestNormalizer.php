...
class AnalyseProductionPaieDetailRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\AnalyseProductionPaieDetailRequest' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\AnalyseProductionPaieDetailRequest' === $data::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('requeteAnalyseProductionDetail', $data) && null !== $data['requeteAnalyseProductionDetail']) {
            $object->setRequeteAnalyseProductionDetail($this->denormalizer->denormalize($data['requeteAnalyseProductionDetail'], 'QdequippeTech\\Silae\\Api\\Model\\RequeteAnalyseProductionDetail', 'json', $context));
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\AnalyseProductionPaieDetailRequest' => false];
    }
}
