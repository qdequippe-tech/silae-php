...
class SalarieAbsenceV3Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return SalarieAbsenceV3::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && SalarieAbsenceV3::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('pourcentageActivite', $data) && \is_int($data['pourcentageActivite'])) {
            $data['pourcentageActivite'] = (float) $data['pourcentageActivite'];
        }
        ...
        if (\array_key_exists('absencePartielleSansEffetSurPSS', $data) && \is_int($data['absencePartielleSansEffetSurPSS'])) {
            $data['absencePartielleSansEffetSurPSS'] = (bool) $data['absencePartielleSansEffetSurPSS'];
        }

        if (\array_key_exists('absenceCompleteAvecInfluencePSS', $data) && \is_int($data['absenceCompleteAvecInfluencePSS'])) {
            $data['absenceCompleteAvecInfluencePSS'] = (bool) $data['absenceCompleteAvecInfluencePSS'];
        }
        ...
        if (\array_key_exists('absencePartielleSansEffetSurPSS', $data) && null !== $data['absencePartielleSansEffetSurPSS']) {
            $object->setAbsencePartielleSansEffetSurPSS($data['absencePartielleSansEffetSurPSS']);
        } elseif (\array_key_exists('absencePartielleSansEffetSurPSS', $data) && null === $data['absencePartielleSansEffetSurPSS']) {
            $object->setAbsencePartielleSansEffetSurPSS(null);
        }

        if (\array_key_exists('absenceCompleteAvecInfluencePSS', $data) && null !== $data['absenceCompleteAvecInfluencePSS']) {
            $object->setAbsenceCompleteAvecInfluencePSS($data['absenceCompleteAvecInfluencePSS']);
        } elseif (\array_key_exists('absenceCompleteAvecInfluencePSS', $data) && null === $data['absenceCompleteAvecInfluencePSS']) {
            $object->setAbsenceCompleteAvecInfluencePSS(null);
        }

        if (\array_key_exists('absenceDebutantPartiellementTravaille', $data) && null !== $data['absenceDebutantPartiellementTravaille']) {
            $object->setAbsenceDebutantPartiellementTravaille($data['absenceDebutantPartiellementTravaille']);
        } elseif (\array_key_exists('absenceDebutantPartiellementTravaille', $data) && null === $data['absenceDebutantPartiellementTravaille']) {
            $object->setAbsenceDebutantPartiellementTravaille(null);
        }

        if (\array_key_exists('typeArret', $data) && null !== $data['typeArret']) {
            $object->setTypeArret($data['typeArret']);
        } elseif (\array_key_exists('typeArret', $data) && null === $data['typeArret']) {
            $object->setTypeArret(null);
        }

        if (\array_key_exists('pourcentageActivite', $data) && null !== $data['pourcentageActivite']) {
            $object->setPourcentageActivite($data['pourcentageActivite']);
        } elseif (\array_key_exists('pourcentageActivite', $data) && null === $data['pourcentageActivite']) {
            $object->setPourcentageActivite(null);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('absencePartielleSansEffetSurPSS') && null !== $data->getAbsencePartielleSansEffetSurPSS()) {
            $dataArray['absencePartielleSansEffetSurPSS'] = $data->getAbsencePartielleSansEffetSurPSS();
        }

        if ($data->isInitialized('absenceCompleteAvecInfluencePSS') && null !== $data->getAbsenceCompleteAvecInfluencePSS()) {
            $dataArray['absenceCompleteAvecInfluencePSS'] = $data->getAbsenceCompleteAvecInfluencePSS();
        }

        if ($data->isInitialized('absenceDebutantPartiellementTravaille') && null !== $data->getAbsenceDebutantPartiellementTravaille()) {
            $dataArray['absenceDebutantPartiellementTravaille'] = $data->getAbsenceDebutantPartiellementTravaille();
        }

        if ($data->isInitialized('typeArret') && null !== $data->getTypeArret()) {
            $dataArray['typeArret'] = $data->getTypeArret();
        }

        if ($data->isInitialized('pourcentageActivite') && null !== $data->getPourcentageActivite()) {
            $dataArray['pourcentageActivite'] = $data->getPourcentageActivite();
        }
    ...
    {
        return [SalarieAbsenceV3::class => false];
    }
}
