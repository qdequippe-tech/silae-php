...
class SalarieReinitialiserSaisiesRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\SalarieReinitialiserSaisiesRequest' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\SalarieReinitialiserSaisiesRequest' === $data::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('reinitialisationSaisies', $data) && null !== $data['reinitialisationSaisies']) {
            $object->setReinitialisationSaisies($this->denormalizer->denormalize($data['reinitialisationSaisies'], 'QdequippeTech\\Silae\\Api\\Model\\SalarieReinitialisationSaisies', 'json', $context));
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\SalarieReinitialiserSaisiesRequest' => false];
    }
}
