...
class RequeteExtraSalarieVacationsV2Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return RequeteExtraSalarieVacationsV2::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && RequeteExtraSalarieVacationsV2::class === $data::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new RequeteExtraSalarieVacationsV2();
        ...
        if (\array_key_exists('vacationBulletin', $data) && null !== $data['vacationBulletin']) {
            $object->setVacationBulletin($data['vacationBulletin']);
        } elseif (\array_key_exists('vacationBulletin', $data) && null === $data['vacationBulletin']) {
            $object->setVacationBulletin(null);
        }
    ...
    {
        $dataArray = [];
        if ($data->isInitialized('vacationBulletin') && null !== $data->getVacationBulletin()) {
            $dataArray['vacationBulletin'] = $data->getVacationBulletin();
        }
    ...
    {
        return [RequeteExtraSalarieVacationsV2::class => false];
    }
}
