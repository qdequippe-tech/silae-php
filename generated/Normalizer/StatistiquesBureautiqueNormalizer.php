...
class StatistiquesBureautiqueNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\StatistiquesBureautique' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\StatistiquesBureautique' === $data::class;
    }
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\StatistiquesBureautique' => false];
    }
}
