...
class SalarieDUERequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\SalarieDUERequest' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\SalarieDUERequest' === $data::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('salarieDUE', $data) && null !== $data['salarieDUE']) {
            $object->setSalarieDUE($this->denormalizer->denormalize($data['salarieDUE'], 'QdequippeTech\\Silae\\Api\\Model\\SalarieDUE', 'json', $context));
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\SalarieDUERequest' => false];
    }
}
