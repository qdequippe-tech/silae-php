...
class SalarieDUERequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \is_object($data) && SalarieDUERequest::class === $data::class;
    }
    ...
    {
        $dataArray = [];
        if ($data->isInitialized('salarieDUE') && null !== $data->getSalarieDUE()) {
            $dataArray['salarieDUE'] = $this->normalizer->normalize($data->getSalarieDUE(), 'json', $context);
        }
