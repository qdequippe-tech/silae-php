...
class ModificationChampNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\ModificationChamp' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\ModificationChamp' === $data::class;
    }
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\ModificationChamp' => false];
    }
}
