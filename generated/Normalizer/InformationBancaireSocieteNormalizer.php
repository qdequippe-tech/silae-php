...
class InformationBancaireSocieteNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\InformationBancaireSociete' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\InformationBancaireSociete' === $data::class;
    }
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\InformationBancaireSociete' => false];
    }
}
