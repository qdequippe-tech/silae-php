...
class ModificationHoraireSalarieNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return ModificationHoraireSalarie::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && ModificationHoraireSalarie::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('bTauxHeuresLibres1', $data) && \is_int($data['bTauxHeuresLibres1'])) {
            $data['bTauxHeuresLibres1'] = (bool) $data['bTauxHeuresLibres1'];
        }

        if (\array_key_exists('bTauxHeuresLibres2', $data) && \is_int($data['bTauxHeuresLibres2'])) {
            $data['bTauxHeuresLibres2'] = (bool) $data['bTauxHeuresLibres2'];
        }

        if (\array_key_exists('bTauxHeuresLibres3', $data) && \is_int($data['bTauxHeuresLibres3'])) {
            $data['bTauxHeuresLibres3'] = (bool) $data['bTauxHeuresLibres3'];
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('bTauxHeuresLibres1') && null !== $data->getBTauxHeuresLibres1()) {
            $dataArray['bTauxHeuresLibres1'] = $data->getBTauxHeuresLibres1();
        }
        ...
        if ($data->isInitialized('bTauxHeuresLibres2') && null !== $data->getBTauxHeuresLibres2()) {
            $dataArray['bTauxHeuresLibres2'] = $data->getBTauxHeuresLibres2();
        }
        ...
        if ($data->isInitialized('bTauxHeuresLibres3') && null !== $data->getBTauxHeuresLibres3()) {
            $dataArray['bTauxHeuresLibres3'] = $data->getBTauxHeuresLibres3();
        }
    ...
    {
        return [ModificationHoraireSalarie::class => false];
    }
}
