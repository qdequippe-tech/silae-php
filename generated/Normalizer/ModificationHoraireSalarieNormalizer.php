...
class ModificationHoraireSalarieNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\ModificationHoraireSalarie' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\ModificationHoraireSalarie' === $data::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new ModificationHoraireSalarie();
        ...
        if (\array_key_exists('bTauxHeuresLibres1', $data) && null !== $data['bTauxHeuresLibres1']) {
            $object->setBTauxHeuresLibres1($data['bTauxHeuresLibres1']);
        } elseif (\array_key_exists('bTauxHeuresLibres1', $data) && null === $data['bTauxHeuresLibres1']) {
            $object->setBTauxHeuresLibres1(null);
        }
        ...
        if (\array_key_exists('bTauxHeuresLibres2', $data) && null !== $data['bTauxHeuresLibres2']) {
            $object->setBTauxHeuresLibres2($data['bTauxHeuresLibres2']);
        } elseif (\array_key_exists('bTauxHeuresLibres2', $data) && null === $data['bTauxHeuresLibres2']) {
            $object->setBTauxHeuresLibres2(null);
        }
        ...
        if (\array_key_exists('bTauxHeuresLibres3', $data) && null !== $data['bTauxHeuresLibres3']) {
            $object->setBTauxHeuresLibres3($data['bTauxHeuresLibres3']);
        } elseif (\array_key_exists('bTauxHeuresLibres3', $data) && null === $data['bTauxHeuresLibres3']) {
            $object->setBTauxHeuresLibres3(null);
        }
    ...
    public function normalize($object, $format = null, array $context = [])
    {
        ...
        if ($object->isInitialized('bTauxHeuresLibres1') && null !== $object->getBTauxHeuresLibres1()) {
            $data['bTauxHeuresLibres1'] = $object->getBTauxHeuresLibres1();
        }
        if ($object->isInitialized('tauxHeuresLibres1') && null !== $object->getTauxHeuresLibres1()) {
            $data['tauxHeuresLibres1'] = $object->getTauxHeuresLibres1();
        }
        if ($object->isInitialized('bTauxHeuresLibres2') && null !== $object->getBTauxHeuresLibres2()) {
            $data['bTauxHeuresLibres2'] = $object->getBTauxHeuresLibres2();
        }
        if ($object->isInitialized('tauxHeuresLibres2') && null !== $object->getTauxHeuresLibres2()) {
            $data['tauxHeuresLibres2'] = $object->getTauxHeuresLibres2();
        }
        if ($object->isInitialized('bTauxHeuresLibres3') && null !== $object->getBTauxHeuresLibres3()) {
            $data['bTauxHeuresLibres3'] = $object->getBTauxHeuresLibres3();
        }
        if ($object->isInitialized('tauxHeuresLibres3') && null !== $object->getTauxHeuresLibres3()) {
            $data['tauxHeuresLibres3'] = $object->getTauxHeuresLibres3();
        }
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\ModificationHoraireSalarie' => false];
    }
}
