...
class DossierPeriodeRangeRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return DossierPeriodeRangeRequest::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && DossierPeriodeRangeRequest::class === $data::class;
    }
    ...
    {
        return [DossierPeriodeRangeRequest::class => false];
    }
}
