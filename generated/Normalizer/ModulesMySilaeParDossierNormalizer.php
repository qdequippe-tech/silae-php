...
class ModulesMySilaeParDossierNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return ModulesMySilaeParDossier::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && ModulesMySilaeParDossier::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new ModulesMySilaeParDossier();
        ...
        if (\array_key_exists('modules', $data) && null !== $data['modules']) {
            ...
            foreach ($data['modules'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, ModuleMySilaeParDossier::class, 'json', $context);
            }
    ...
    {
        return [ModulesMySilaeParDossier::class => false];
    }
}
