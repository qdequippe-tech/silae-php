...
class SalarieAbsenceV2Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return SalarieAbsenceV2::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && SalarieAbsenceV2::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('valeurPourcentage', $data) && \is_int($data['valeurPourcentage'])) {
            $data['valeurPourcentage'] = (float) $data['valeurPourcentage'];
        }
        ...
        if (\array_key_exists('sansInfluencePSS', $data) && \is_int($data['sansInfluencePSS'])) {
            $data['sansInfluencePSS'] = (bool) $data['sansInfluencePSS'];
        }
        ...
        if (\array_key_exists('avecInfluencePSS', $data) && \is_int($data['avecInfluencePSS'])) {
            $data['avecInfluencePSS'] = (bool) $data['avecInfluencePSS'];
        }
        ...
        if (\array_key_exists('valeurPourcentage', $data) && null !== $data['valeurPourcentage']) {
            $object->setValeurPourcentage($data['valeurPourcentage']);
        } elseif (\array_key_exists('valeurPourcentage', $data) && null === $data['valeurPourcentage']) {
            $object->setValeurPourcentage(null);
        }

        if (\array_key_exists('sansInfluencePSS', $data) && null !== $data['sansInfluencePSS']) {
            $object->setSansInfluencePSS($data['sansInfluencePSS']);
        } elseif (\array_key_exists('sansInfluencePSS', $data) && null === $data['sansInfluencePSS']) {
            $object->setSansInfluencePSS(null);
        }
        ...
        if (\array_key_exists('avecInfluencePSS', $data) && null !== $data['avecInfluencePSS']) {
            $object->setAvecInfluencePSS($data['avecInfluencePSS']);
        } elseif (\array_key_exists('avecInfluencePSS', $data) && null === $data['avecInfluencePSS']) {
            $object->setAvecInfluencePSS(null);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('valeurPourcentage') && null !== $data->getValeurPourcentage()) {
            $dataArray['valeurPourcentage'] = $data->getValeurPourcentage();
        }

        if ($data->isInitialized('sansInfluencePSS') && null !== $data->getSansInfluencePSS()) {
            $dataArray['sansInfluencePSS'] = $data->getSansInfluencePSS();
        }
        ...
        if ($data->isInitialized('avecInfluencePSS') && null !== $data->getAvecInfluencePSS()) {
            $dataArray['avecInfluencePSS'] = $data->getAvecInfluencePSS();
        }
    ...
    {
        return [SalarieAbsenceV2::class => false];
    }
}
