...
class SalarieAbsenceV2Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\SalarieAbsenceV2' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\SalarieAbsenceV2' === $data::class;
    }
    ...
    public function normalize($object, $format = null, array $context = [])
    {
        ...
        if ($object->isInitialized('valeurPourcentage') && null !== $object->getValeurPourcentage()) {
            $data['valeurPourcentage'] = $object->getValeurPourcentage();
        }
        if ($object->isInitialized('sansInfluencePSS') && null !== $object->getSansInfluencePSS()) {
            $data['sansInfluencePSS'] = $object->getSansInfluencePSS();
        }
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\SalarieAbsenceV2' => false];
    }
}
