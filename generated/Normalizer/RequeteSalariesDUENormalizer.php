...
class RequeteSalariesDUENormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\RequeteSalariesDUE' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\RequeteSalariesDUE' === $data::class;
    }
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\RequeteSalariesDUE' => false];
    }
}
