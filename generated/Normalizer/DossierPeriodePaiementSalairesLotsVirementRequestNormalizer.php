...
class DossierPeriodePaiementSalairesLotsVirementRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return DossierPeriodePaiementSalairesLotsVirementRequest::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && DossierPeriodePaiementSalairesLotsVirementRequest::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new DossierPeriodePaiementSalairesLotsVirementRequest();
    ...
    {
        return [DossierPeriodePaiementSalairesLotsVirementRequest::class => false];
    }
}
