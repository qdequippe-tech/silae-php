...
class ImportXmlParametrageOrganismeDSNResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return ImportXmlParametrageOrganismeDSNResponse::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && ImportXmlParametrageOrganismeDSNResponse::class === $data::class;
    }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('compteRendu') && null !== $data->getCompteRendu()) {
            $dataArray['compteRendu'] = $data->getCompteRendu();
        }

        if ($data->isInitialized('traitementGlobal') && null !== $data->getTraitementGlobal()) {
            $dataArray['traitementGlobal'] = $data->getTraitementGlobal();
        }
    ...
    {
        return [ImportXmlParametrageOrganismeDSNResponse::class => false];
    }
}
