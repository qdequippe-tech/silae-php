...
class LectureFicheAgenceRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\LectureFicheAgenceRequest' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\LectureFicheAgenceRequest' === $data::class;
    }
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\LectureFicheAgenceRequest' => false];
    }
}
