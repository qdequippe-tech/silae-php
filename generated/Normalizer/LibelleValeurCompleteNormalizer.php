...
class LibelleValeurCompleteNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\LibelleValeurComplete' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\LibelleValeurComplete' === $data::class;
    }
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\LibelleValeurComplete' => false];
    }
}
