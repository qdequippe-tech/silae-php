...
class CreationDossierParImportFichierDSNRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \is_object($data) && $data instanceof CreationDossierParImportFichierDSNRequest;
    }
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\CreationDossierParImportFichierDSNRequest' => false];
    }
}
