...
if (!class_exists(Kernel::class) || (Kernel::MAJOR_VERSION >= 7 || Kernel::MAJOR_VERSION === 6 && Kernel::MINOR_VERSION === 4)) {
    class EcrituresComptablesAvecRupturesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        use CheckArray;
        ...
        {
            return EcrituresComptablesAvecRuptures::class === $type;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return \is_object($data) && EcrituresComptablesAvecRuptures::class === $data::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new EcrituresComptablesAvecRuptures();
            ...
            if (\array_key_exists('ruptures', $data) && null !== $data['ruptures']) {
                $values = [];
                foreach ($data['ruptures'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, EcrituresComptablesRupture::class, 'json', $context);
                }

                $object->setRuptures($values);
            } elseif (\array_key_exists('ruptures', $data) && null === $data['ruptures']) {
                $object->setRuptures(null);
            }
        ...
        public function normalize(mixed $object, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('ruptures') && null !== $object->getRuptures()) {
                $values = [];
                foreach ($object->getRuptures() as $value) {
                    $values[] = $this->normalizer->normalize($value, 'json', $context);
                }

                $data['ruptures'] = $values;
            }
        ...
        {
            return [EcrituresComptablesAvecRuptures::class => false];
        }
    }
} else {
    class EcrituresComptablesAvecRupturesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
