...
class SalarieAjouterActiviteJournaliereRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return SalarieAjouterActiviteJournaliereRequest::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && SalarieAjouterActiviteJournaliereRequest::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new SalarieAjouterActiviteJournaliereRequest();
    ...
    {
        return [SalarieAjouterActiviteJournaliereRequest::class => false];
    }
}
