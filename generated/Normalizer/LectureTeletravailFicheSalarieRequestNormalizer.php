...
class LectureTeletravailFicheSalarieRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return LectureTeletravailFicheSalarieRequest::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && LectureTeletravailFicheSalarieRequest::class === $data::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new LectureTeletravailFicheSalarieRequest();
    ...
    {
        return [LectureTeletravailFicheSalarieRequest::class => false];
    }
}
