...
class EcrituresComptablesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\EcrituresComptables' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\EcrituresComptables' === $data::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('ecritures', $data) && null !== $data['ecritures']) {
            ...
            foreach ($data['ecritures'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'QdequippeTech\\Silae\\Api\\Model\\EcrituresComptablesLigne', 'json', $context);
            }
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\EcrituresComptables' => false];
    }
}
