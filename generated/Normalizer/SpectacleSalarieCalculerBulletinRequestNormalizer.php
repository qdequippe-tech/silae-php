...
class SpectacleSalarieCalculerBulletinRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\SpectacleSalarieCalculerBulletinRequest' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\SpectacleSalarieCalculerBulletinRequest' === $data::class;
    }
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\SpectacleSalarieCalculerBulletinRequest' => false];
    }
}
