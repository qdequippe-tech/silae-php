...
class SalarieAbsencesRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \is_object($data) && SalarieAbsencesRequest::class === $data::class;
    }
    ...
    {
        $dataArray = [];
        if ($data->isInitialized('requeteSalarieAbsences') && null !== $data->getRequeteSalarieAbsences()) {
            $dataArray['requeteSalarieAbsences'] = $this->normalizer->normalize($data->getRequeteSalarieAbsences(), 'json', $context);
        }
