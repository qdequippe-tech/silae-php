...
class SalarieAbsencesRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\SalarieAbsencesRequest' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\SalarieAbsencesRequest' === $data::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('requeteSalarieAbsences', $data) && null !== $data['requeteSalarieAbsences']) {
            $object->setRequeteSalarieAbsences($this->denormalizer->denormalize($data['requeteSalarieAbsences'], 'QdequippeTech\\Silae\\Api\\Model\\RequeteSalarieAbsences', 'json', $context));
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\SalarieAbsencesRequest' => false];
    }
}
