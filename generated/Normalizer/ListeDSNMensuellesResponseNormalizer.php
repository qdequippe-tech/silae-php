...
class ListeDSNMensuellesResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\ListeDSNMensuellesResponse' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\ListeDSNMensuellesResponse' === $data::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('listeDSNMensuelles', $data) && null !== $data['listeDSNMensuelles']) {
            ...
            foreach ($data['listeDSNMensuelles'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'QdequippeTech\\Silae\\Api\\Model\\DSNMensuelle', 'json', $context);
            }
    ...
    {
        $data = [];
        if ($object->isInitialized('listeDSNMensuelles') && null !== $object->getListeDSNMensuelles()) {
            $values = [];
            foreach ($object->getListeDSNMensuelles() as $value) {
                $values[] = $this->normalizer->normalize($value, 'json', $context);
            }
            $data['listeDSNMensuelles'] = $values;
        }
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\ListeDSNMensuellesResponse' => false];
    }
}
