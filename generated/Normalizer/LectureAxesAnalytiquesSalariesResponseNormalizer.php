...
class LectureAxesAnalytiquesSalariesResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        $dataArray = [];
        if ($data->isInitialized('axesAnalytiqueSalarie') && null !== $data->getAxesAnalytiqueSalarie()) {
            $values = [];
            foreach ($data->getAxesAnalytiqueSalarie() as $value) {
                $values[] = $this->normalizer->normalize($value, 'json', $context);
            }

            $dataArray['axesAnalytiqueSalarie'] = $values;
        }
