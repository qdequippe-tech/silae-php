...
class SalarieModifierAbsenceRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return SalarieModifierAbsenceRequest::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && SalarieModifierAbsenceRequest::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new SalarieModifierAbsenceRequest();
        ...
        if (\array_key_exists('absence_Modif', $data) && null !== $data['absence_Modif']) {
            $object->setAbsenceModif($this->denormalizer->denormalize($data['absence_Modif'], SalarieAbsenceV2::class, 'json', $context));
    ...
    {
        return [SalarieModifierAbsenceRequest::class => false];
    }
}
