...
class ListeDossiersRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\ListeDossiersRequest' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\ListeDossiersRequest' === $data::class;
    }
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\ListeDossiersRequest' => false];
    }
}
