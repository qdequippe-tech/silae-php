...
class SalarieAjouterAcompteRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\SalarieAjouterAcompteRequest' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\SalarieAjouterAcompteRequest' === $data::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('acompte', $data) && null !== $data['acompte']) {
            $object->setAcompte($this->denormalizer->denormalize($data['acompte'], 'QdequippeTech\\Silae\\Api\\Model\\SalarieAcompte', 'json', $context));
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\SalarieAjouterAcompteRequest' => false];
    }
}
