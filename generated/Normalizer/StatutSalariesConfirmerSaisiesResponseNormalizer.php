...
class StatutSalariesConfirmerSaisiesResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \is_object($data) && StatutSalariesConfirmerSaisiesResponse::class === $data::class;
    }
    ...
    {
        $dataArray = [];
        if ($data->isInitialized('saisiesHeuresConfirmees') && null !== $data->getSaisiesHeuresConfirmees()) {
            $dataArray['saisiesHeuresConfirmees'] = $data->getSaisiesHeuresConfirmees();
        }

        if ($data->isInitialized('saisiesPrimesConfirmees') && null !== $data->getSaisiesPrimesConfirmees()) {
            $dataArray['saisiesPrimesConfirmees'] = $data->getSaisiesPrimesConfirmees();
        }
