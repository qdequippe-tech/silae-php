...
class StatutSalariesConfirmerSaisiesResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'QdequippeTech\\Silae\\Api\\Model\\StatutSalariesConfirmerSaisiesResponse' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'QdequippeTech\\Silae\\Api\\Model\\StatutSalariesConfirmerSaisiesResponse' === $data::class;
    }
    ...
    {
        return ['QdequippeTech\\Silae\\Api\\Model\\StatutSalariesConfirmerSaisiesResponse' => false];
    }
}
