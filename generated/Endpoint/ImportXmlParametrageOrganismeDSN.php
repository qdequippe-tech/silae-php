...
class ImportXmlParametrageOrganismeDSN extends BaseEndpoint implements Endpoint
{
    use EndpointTrait;
     ...
     *             }
     */
    public function __construct(ImportXmlParametrageOrganismeDSNRequest $request, array $headerParameters = [])
    {
        $this->body = $request;
