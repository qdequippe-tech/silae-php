...
class CreationQuestionnaireContratComplementaire extends BaseEndpoint implements Endpoint
{
    use EndpointTrait;
     ...
     *             }
     */
    public function __construct(CreationQuestionnaireContratComplementaireRequest $request, array $headerParameters = [])
    {
        $this->body = $request;
    ...
    {
        return '/v1/ContratComplementaire/CreationQuestionnaireContratComplementaire';
    }
    ...
    /**
     * @return QuestionnaireContratComplementaire
     *
