...
class ModificationQuestionnaireCCNEtablissement extends BaseEndpoint implements Endpoint
{
    use EndpointTrait;
     ...
     *             }
     */
    public function __construct(ModificationQuestionnaireCCNEtablissementRequest $request, array $headerParameters = [])
    {
        $this->body = $request;
