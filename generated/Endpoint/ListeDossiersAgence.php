...
class ListeDossiersAgence extends BaseEndpoint implements Endpoint
{
     ...
     *             }
     */
    public function __construct(ListeDossiersAgenceRequest $request, array $headerParameters = [])
    {
        $this->body = $request;
    ...
    {
        return '/v1/AdminAgences/ListeDossiersAgence';
    }
    ...
    /**
     * @return ListeDossiersAgenceResponse|null
     *
