...
class AcquisitionContenuPartielDSN extends BaseEndpoint implements Endpoint
{
    use EndpointTrait;
     ...
     *             }
     */
    public function __construct(AcquisitionContenuPartielDSNRequest $request, array $headerParameters = [])
    {
        $this->body = $request;
