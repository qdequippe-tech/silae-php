...
class AdministrationCollaborateurEnregistrement extends BaseEndpoint implements Endpoint
{
    use EndpointTrait;
     ...
     *             }
     */
    public function __construct(AdministrationCollaborateurEnregistrementRequest $request, array $headerParameters = [])
    {
        $this->body = $request;
