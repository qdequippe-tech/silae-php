...
class ExtraSalarieReinitialiserVacations extends BaseEndpoint implements Endpoint
{
    use EndpointTrait;
     ...
     *             }
     */
    public function __construct(ExtraSalarieReinitialiserVacationsRequest $request, array $headerParameters = [])
    {
        $this->body = $request;
    ...
    /**
     * @return ExtraSalarieReinitialiserVacationsResponse|null
     *
