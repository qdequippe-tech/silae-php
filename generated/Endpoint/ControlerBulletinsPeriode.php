...
class ControlerBulletinsPeriode extends BaseEndpoint implements Endpoint
{
    use EndpointTrait;
     ...
     *             }
     */
    public function __construct(ControlerBulletinsPeriodeRequest $request, array $headerParameters = [])
    {
        $this->body = $request;
    ...
    /**
     * @return ControlerBulletinsPeriodeResponse|null
     *
