...
class LectureContactEmetteurDSN extends BaseEndpoint implements Endpoint
{
    use EndpointTrait;
     ...
     *             }
     */
    public function __construct(LectureContactEmetteurDSNRequest $request, array $headerParameters = [])
    {
        $this->body = $request;
