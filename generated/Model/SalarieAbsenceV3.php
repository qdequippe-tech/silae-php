...
class SalarieAbsenceV3
{
     ...
     * @var bool|null
     */
    protected $absencePartielleSansEffetSurPSS;

    /**
     * @var bool|null
     */
    protected $absenceCompleteAvecInfluencePSS;

    /**
     * @var bool|null
     */
    protected $absenceDebutantPartiellementTravaille;
    ...
    public function getAbsencePartielleSansEffetSurPSS(): ?bool
    {
        return $this->absencePartielleSansEffetSurPSS;
    }

    public function setAbsencePartielleSansEffetSurPSS(?bool $absencePartielleSansEffetSurPSS): self
    {
        $this->initialized['absencePartielleSansEffetSurPSS'] = true;
        $this->absencePartielleSansEffetSurPSS = $absencePartielleSansEffetSurPSS;

        return $this;
    }

    public function getAbsenceCompleteAvecInfluencePSS(): ?bool
    {
        return $this->absenceCompleteAvecInfluencePSS;
    }

    public function setAbsenceCompleteAvecInfluencePSS(?bool $absenceCompleteAvecInfluencePSS): self
    {
        $this->initialized['absenceCompleteAvecInfluencePSS'] = true;
        $this->absenceCompleteAvecInfluencePSS = $absenceCompleteAvecInfluencePSS;

        return $this;
    }

    public function getAbsenceDebutantPartiellementTravaille(): ?bool
    {
        return $this->absenceDebutantPartiellementTravaille;
    }

    public function setAbsenceDebutantPartiellementTravaille(?bool $absenceDebutantPartiellementTravaille): self
    {
        $this->initialized['absenceDebutantPartiellementTravaille'] = true;
        $this->absenceDebutantPartiellementTravaille = $absenceDebutantPartiellementTravaille;

        return $this;
    }

    public function getTypeArret(): ?int
    {
        return $this->typeArret;
    }

    public function setTypeArret(?int $typeArret): self
    {
        $this->initialized['typeArret'] = true;
        $this->typeArret = $typeArret;

        return $this;
    }

    public function getPourcentageActivite(): ?float
    {
        return $this->pourcentageActivite;
    }

    public function setPourcentageActivite(?float $pourcentageActivite): self
    {
        $this->initialized['pourcentageActivite'] = true;
