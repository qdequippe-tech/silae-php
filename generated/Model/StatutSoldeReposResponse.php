...
class StatutSoldeReposResponse
{
    /**
     * @var array
     */
    ...
    public function getSoldeRepos(): ?SoldeRepos
    {
        return $this->soldeRepos;
    }

    public function setSoldeRepos(?SoldeRepos $soldeRepos): self
    {
        $this->initialized['soldeRepos'] = true;
