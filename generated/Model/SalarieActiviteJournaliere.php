...
class SalarieActiviteJournaliere
{
    /**
     * @var array
     */
     ...
     * @var bool|null
     */
    protected $reinitialiserJournee;
    ...
    public function getReinitialiserJournee(): ?bool
    {
        return $this->reinitialiserJournee;
    }

    public function setReinitialiserJournee(?bool $reinitialiserJournee): self
    {
        $this->initialized['reinitialiserJournee'] = true;
        $this->reinitialiserJournee = $reinitialiserJournee;
