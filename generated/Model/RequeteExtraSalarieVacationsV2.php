...
class RequeteExtraSalarieVacationsV2
{
    /**
     * @var array
     */
    ...
    public function getVacationBulletin(): ?int
    {
        return $this->vacationBulletin;
    }

    public function setVacationBulletin(?int $vacationBulletin): self
    {
        $this->initialized['vacationBulletin'] = true;
        $this->vacationBulletin = $vacationBulletin;
