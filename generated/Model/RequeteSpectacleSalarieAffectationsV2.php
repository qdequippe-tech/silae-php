...
class RequeteSpectacleSalarieAffectationsV2
{
    /**
     * @var array
     */
    ...
    public function getAffectationBulletin(): ?int
    {
        return $this->affectationBulletin;
    }

    public function setAffectationBulletin(?int $affectationBulletin): self
    {
        $this->initialized['affectationBulletin'] = true;
        $this->affectationBulletin = $affectationBulletin;
