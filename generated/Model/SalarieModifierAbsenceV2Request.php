...
class SalarieModifierAbsenceV2Request
{
    /**
     * @var array
     */
    ...
    public function getAbsenceModif(): ?SalarieAbsenceV3
    {
        return $this->absenceModif;
    }

    public function setAbsenceModif(?SalarieAbsenceV3 $absenceModif): self
    {
